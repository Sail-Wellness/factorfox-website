...
A contra relationship is a tier one question that most intake processes never ask, because it is a question about the client's payables rather than its receivables. Ask it at onboarding, and ask again when a debtor's payment behavior changes shape rather than simply slowing.

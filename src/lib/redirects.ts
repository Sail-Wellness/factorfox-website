...
export const LEGACY_REDIRECTS: Redirect[] = [
  ...
  /* Addresses people and old links guess at. Added September 2026. */
  { source: "/contact", destination: "/demo" },
  { source: "/login", destination: "/" },
  { source: "/sign-in", destination: "/" },
  { source: "/signin", destination: "/" },
  { source: "/press", destination: "/news" },
  { source: "/newsroom", destination: "/news" },
  { source: "/factoring-software", destination: "/" },
  { source: "/ai-factoring-software", destination: "/platform/ai-native" },
  { source: "/invoice-factoring-software", destination: "/solutions/factoring" },
  { source: "/best-factoring-software", destination: "/resources/best-factoring-software" },

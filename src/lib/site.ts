...
export const NAV: NavGroup[] = [
  {
    ...
    children: [
      ...
      { href: "/platform/risk-monitoring", label: "Risk monitoring", note: "Debtor behavior, concentration, dilution" },
      ...
      { href: "/platform/fraud-detection", label: "Fraud detection", note: "Behavioral combinations, not single flags" },
      { href: "/platform/collections", label: "Collections", note: "Prioritized by exposure and promise history" },
